...
import PoductReviewCard from './ProductReviewCard';
...
<div className="overflow-hidden rounded-lg max-w-[30rem] max-h-[35rem]">
            ...
            <div className="flex flex-wrap space-x-5 justify-center">
                {product.images.map((item) =><div className="aspect-h-2 aspect-w-3 overflow-hidden rounded-lg max-w-[5rem] max-h-[5rem] mt-10">
                <img
                  src={item.src}
                  alt={item.alt}
                  className="h-full w-full object-cover object-center"
          ...
          <div className="lg:col-span-1 maxt-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">
            <div className="lg:col-span-2 ">
              ...
              <h1 className="text-lg lg:text-xl text-gray-900 opacity-60 pt-1">this is very good thing</h1>
            </div>
...
<p className="text-green-600 font-semibold">10%</p>
              ...
              <p className="ml-3 text-sm font-medium text-indigo-500 hover:text-indigo-600"> 856 Reviews</p>
              </div>
            ...
            <Grid container spacing={7}>
                <Grid item xs={7}>
                    <div className="space-y-5">
                        {[1,1,1].map((item)=><PoductReviewCard/>) }
                    </div>
                </Grid>
                <Grid item xs={5}>
